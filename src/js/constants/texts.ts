export const TEXTS = {
  ...
  TRANSLATION_SOURCES: {
    ...
    'ds prof sahib singh': 'DS - Prof Sahib Singh',
  ...
  SHABAD_RATING: {
    ...
    TAGLINE: `You are reviewing the English rendering of Professor Sahib Singh Ji's original Punjabi Teeka.`,
    TEEKA_REVIEW_HEADING: 'Feedback on the Original Punjabi Teeka (Optional)',
    TEEKA_REVIEW_TAGLINE: `If you believe certain portions of Professor Sahib Singh Ji's original Punjabi 
    Teeka would benefit from clarification, refinement, or contextual expansion, you may share your observations below.`,
    TEEKA_REVIEW_PLACEHOLDER: `Share constructive insights with respect and academic care. Cite historical, linguistic, or interpretive references where applicable.`,
    SOURCE_HEADING: 'Sources',
    SOURCE_TAGLINE: `If your feedback is informed by specific scholarly works, dictionaries, historical sources, or commentaries, please include them below.`,
    ACCURACY_QUESTION: 'Did it convey the same meaning as described by Prof. Sahib Singh in his teeka?',
  ...
  VERSE_REVIEW_OPTIONS: {
    0: 'Please select an option',
    1: 'Translation is incorrect',
    2: 'Teeka is incorrect',
    3: 'Translation can be improved',
    4: 'Other',
